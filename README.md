...
- 全新首页工作台：重构设备状态、当前应用、常用操作和系统指标卡片，信息层级更清晰
- 设备控制升级：整合按键模拟与设备镜像入口，镜像设置改为独立配置弹窗
- 录屏体验优化：新增录屏设置弹窗、录制中状态弹窗、计时显示和停止控制
- 诊断页面优化：日志与进程页面统一为更紧凑的诊断工具风格
- 桌面打包增强：补充 Linux 打包产物，Windows 便携包和安装包文件名带版本号
- Windows 字体渲染优化：增加系统字体抗锯齿 JVM 参数，改善部分 Windows 环境字体发虚问题
- 详细内容见 [CHANGELOG-v2.1.0.md](./CHANGELOG-v2.1.0.md)
